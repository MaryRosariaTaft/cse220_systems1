...
# atoui
atoui_header: .asciiz "\n\n********* atoui *********\n"
atoui_input: .ascii "723go1" #"-723go1"

# uitoa
uitoa_header: .asciiz "\n\n********* uitoa *********\n"
.align 2
uitoa_value: .word 2147483647
...
runLengthDecode_input: .asciiz "sss!j4q!F15p"
runLengthDecode_output: .asciiz "jhjkhasd987(!@q2j312kja214asasHJU!#Kasjd21"
.align 2
runLengthDecode_outputSize: .word 28
...
runLengthEncode_input: .asciiz "AAAhhhhhhhabcd"
runLengthEncode_output: .asciiz "f78raewkuiO*A&*(QAWE2qp8947kjdfs244"
.align 2
runLengthEncode_outputSize: .word 20
...
main:
    ...
    print_newline()
    print_string(str_result)
    print_string_reg($s0) #change to $s1 to check pointer location
    print_newline()
